...
/> <
Route path = { 'advancedTable' }
components = { AdvancedTable }
/> <
Route path = { 'asynchronousTable' }
components = { AsynchronousTable }
/> <
/Route> <
Route path = { 'chart' } >
    <
...
Route path = { 'animation' } >
    <
    Route path = { 'basicAnimations' }
component = { BasicAnimations }
/> <
Route path = { 'exampleAnimations' }
...
Route path = "atest" >
    <
    Route path = "cssmodule"
getComponent = { CssModuleT }
/> <
/Route> <
/Route> <
Route path = { 'login' }
